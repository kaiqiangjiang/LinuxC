...
#define MCP2510_CS_OUT      ( rGPBCON = rGPBCON & (~(3<<14)) | (1<<14) )      //GPB7    
#define MCP2510_CS_H        ( rGPBDAT = rGPBDAT | (1<<7) )    
#define MCP2510_CS_L        ( rGPBDAT = rGPBDAT & (~(1<<7))  ) 
...
{   
    ...
    {    
        ...
        Uart_Printf( "  ID=0x%x\n",id );   
        Uart_Printf( "Reveice Data=%d,%d,%d,%d,%d,%d,%d,%d\n",data_read[0],data_read[1],data_read[2],data_read[3],data_read[4],data_read[5],data_read[6],data_read[7] );   
