...
File Name	: camtest.c
Descriptions
  - camera test routines & basic libraries
*************************************************************/
...
extern unsigned short LCD_BUFFER[SCR_YSIZE_TFT_320240][SCR_XSIZE_TFT_320240];
...
//	else if(LCD_Type == LCD35)
		CamInit(320, 480, 320, 480, 0, 0,  CAM_FRAMEBUFFER_C, CAM_FRAMEBUFFER_P);		
	Uart_Printf("preview sc control = %x\n", rCIPRSCCTRL);
