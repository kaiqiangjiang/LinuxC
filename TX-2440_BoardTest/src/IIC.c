...
void Test_IIC(void)
{
    ...
    Uart_Printf("\n[ IIC Test(Interrupt) using AT24C04 ]\n");
...
void Test_II2(void)
{
    ...
    Uart_Printf("[ IIC Test(Polling) using AT24C04 ]\n");
    ...
    for(i=0;i<256;i++)
        _Wr24C04(0xa0,(U8)i,255-i);
    for(i=0;i<256;i++)
        data[i] = 0;

    Uart_Printf("Read test data from AT24C04\n");
    for(i=0;i<256;i++)
        _Rd24C04(0xa0,(U8)i,&(data[i])); 
...
//**************[ _Wr24C04 ]*****************************************
void _Wr24C04(U32 slvAddr,U32 addr,U8 data)
{
    _iicMode      = WRDATA;
    _iicPt        = 0;
    _iicData[0]   = (U8)addr;
...
//************************[ _Rd24C04 ]********************************
void _Rd24C04(U32 slvAddr,U32 addr,U8 *data)
{
    _iicMode      = SETRDADDR;
    _iicPt        = 0;
    _iicData[0]   = (U8)addr;
